...
const EighthPage = () => {
  return (
    <>
      <div className="eighth-main-container">
        <div className='furniking'>
            <h5><img src={furniture} alt="" style={{width:"30px"}} />Furniking</h5>
            <h6>Furniking is a Popular E-commerce Website</h6>
            <h6 style={{lineHeight:"25px"}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas, quibusdam.</h6>
      ...
      <div className='rights'>
            <span>&copy; 2024 Furniking - All Rights Reserved</span>
            <ul>
                <li>Privacy</li>
                <li>Security</li>
                <li>Terms</li>
